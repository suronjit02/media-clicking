    ...
    <section className="w-full bg-base-200 flex flex-col gap-10 md:gap-20 py-16 md:py-30 px-5 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto w-full">
        {insights.map((insight, i) => (
          <FadeIn key={insight.id} direction="up" delay={i * 0.1} duration={0.65}>
            <div className="relative bg-white rounded-2xl shadow-md overflow-hidden border border-transparent hover:border-purple-300 transition-all duration-400">
