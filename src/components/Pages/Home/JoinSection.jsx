  ...
  return (
    <section className="max-w-7xl mx-auto flex flex-col gap-10 md:gap-15 px-5 md:px-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <FadeIn direction="left" duration={0.7} className="flex-1">
        ...
        <FadeIn direction="right" delay={0.1} duration={0.7} className="flex-1 flex md:justify-end">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {joinOpenings.map((item, i) => {
          const Icon = item.icon;
          return (
            <FadeIn key={item.id} direction="up" delay={i * 0.08} duration={0.65}>
              <div className="flex justify-between items-center bg-base-200 hover:bg-white border-2 border-gray-200 rounded-2xl p-7 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
